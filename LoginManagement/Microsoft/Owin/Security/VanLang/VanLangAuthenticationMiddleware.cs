...
namespace Microsoft.Owin.Security.VanLang
{
    ...
    public class VanLangAuthenticationMiddleware : AuthenticationMiddleware<VanLangAuthenticationOptions>
    {
            ...
            : base(next, options)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Exception_OptionMustBeProvided", "ClientId"));
            }
            if (string.IsNullOrWhiteSpace(Options.ClientSecret))
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Exception_OptionMustBeProvided", "ClientSecret"));
            }
